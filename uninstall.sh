...
helm uninstall monitoring -n mimir || true
...
helm uninstall seaweedfs -n seaweedfs || true

# Delete secrets
echo ""
echo "Step 4: Removing secrets..."
...
kubectl delete namespace seaweedfs --ignore-not-found
